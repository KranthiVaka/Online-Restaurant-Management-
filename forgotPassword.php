		...
		<div id="login" class="animate form">
         ...
         <div id="settingLogin">
            ...
            <form action="" method="post" >
             ...
             <div style="top:100%; position: absolute; left:35%; font-family: 'FranchiseRegular','Arial Narrow',Arial,sans-serif; display: bold; font-size: 20px;">
