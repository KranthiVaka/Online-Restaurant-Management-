...
$(document).ready(function(){	
		$(".form-item").submit(function(e){
			...
			$.ajax({ //make ajax request to cart_process.php
				url: "cart_processKebabhouse.php",
				type: "POST",
	...
	$( ".cart-box").click(function(e) { //when user clicks on cart box
		...
		$("#shopping-cart-results" ).load( "cart_processKebabhouse.php", {"load_cart":"1"}); //Make ajax request using jQuery Load() & update results
	});
	...
	$("#shopping-cart-results").on('click', 'a.remove-item', function(e) {
		...
		$.getJSON( "cart_processKebabhouse.php", {"remove_code":pcode} , function(data){ //get Item count from Server
...
$results = $mysqli_conn->query("SELECT menu,price FROM kebabhouse");
