...
$(document).ready(function(){	
	...
	$( ".cart-box").click(function(e) { //when user clicks on cart box
		...
		$("#shopping-cart-results" ).load( "cart_processIndisk.php", {"load_cart":"1"}); //Make ajax request using jQuery Load() & update results
	});
...
$results = $mysqli_conn->query("SELECT menu,price FROM indisk");
